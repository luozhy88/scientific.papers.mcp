 ...
 */
export async function fetchPdfContent(input) {
    try {
        // Validate input
        ...
        const result = await extractor.extractText(validatedInput.url, (progress) => {
 ...
 */
async function handleAutoConfirmation(metadata, maxSizeMB) {
 ...
 */
function assessContextImpact(sizeMB) {
    if (sizeMB <= 10)
        return "low";
    if (sizeMB <= 25)
        return "medium";
...
//# sourceMappingURL=fetch-pdf-content.js.map