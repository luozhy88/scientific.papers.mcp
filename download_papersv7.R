#!/usr/bin/env Rscript
# =============================================================================
# 学术文献搜索与 PDF 下载工具（多源 PDF 增强版 2.3）
# 更新说明: 
# v2.3: 即使下载失败，也保留并输出 OpenAlex 和 Europe PMC 解析出的 PDF 链接到 CSV
# v2.2: 新增 Unpaywall / Semantic Scholar / PMC / arXiv 镜像
# =============================================================================
...
main <- function() {
  ...
  cat("\n╔══════════════════════════════════════════════════════════╗\n")
  cat("║   学术文献搜索与 PDF 下载工具（多源 PDF 增强版 2.3）     ║\n")
  cat("╚══════════════════════════════════════════════════════════╝\n\n")
